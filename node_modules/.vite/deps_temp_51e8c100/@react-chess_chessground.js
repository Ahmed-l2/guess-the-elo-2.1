...
// node_modules/@react-chess/chessground/build/esm/index.js
...
function Chessground2(_a) {
  ...
  var _f = (0, import_react.useState)(null), api = _f[0], setApi = _f[1];
  var ref = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(function() {
    if (ref && ref.current && !api) {
      var chessgroundApi = Chessground(ref.current, __assign({ animation: { enabled: true, duration: 200 } }, config));
  ...
  return import_react.default.createElement(
    "div",
    { style: { height: contained ? "100%" : height, width: contained ? "100%" : width } },
    import_react.default.createElement("div", { ref, style: { height: "100%", width: "100%", display: "table" } })
  );
}
var esm_default = Chessground2;
export {
  esm_default as default
};
//# sourceMappingURL=@react-chess_chessground.js.map
